  ...
  React.useEffect(async () => {
    await firestore()
      ...
      .onSnapshot(snapshot => {
        ...
        setPost(newPost.filter(x => x.value === 'carodic'));
      });
  }, []);
  return (
    <SafeAreaView>
        ...
        <View>
          <Card style={styles.hcard}>
            <ImageBackground
              ...
              <Text style={styles.head}>Equipment Use In Carodic Workout</Text>
            </ImageBackground>
          </Card>
          {post.map(post => (
...
export default CarodicExecrise;
